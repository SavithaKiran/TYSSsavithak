...
public class Bluestoneoffer1 {
	...
	public void testmain() throws Exception {
		...
		Thread.sleep(1000);
		String estate = driver.findElement(By.xpath("//div[@class='bottom-header']/div/nav/ul/li/a[(text()='Offers ')]/following-sibling::div/ul/descendant::li/span[@data-p='offers-75mcoff,m']")).getText();
		driver.findElement(By.xpath("//div[@class='bottom-header']/div/nav/ul/li/a[(text()='Offers ')]/following-sibling::div/ul/descendant::li/span[text()='75% off on Making Charge']")).click();
